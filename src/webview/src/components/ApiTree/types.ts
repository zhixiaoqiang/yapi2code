...
import type { treeLevelTypeEnum } from '../DataTree/constants'
import { EditorValueOpenTypeEnum } from './../../../../constant/vscode'

export enum menuKeyEnum {
  /** 显示文档 */
  show = EditorValueOpenTypeEnum.show,
  /** 刷新 */
  refresh = 'refresh',
  /** 禁用 */
  disable = 'disable',
  ...
  delete = 'delete',
  /** 复制 */
  copy = EditorValueOpenTypeEnum.copy,
  /** 插入到光标处 */
  insertToPosition = EditorValueOpenTypeEnum.insertToPosition,
  /** 新窗口打开 */
  openWindow = EditorValueOpenTypeEnum.openWindow,
}
